@charset "UTF-8";
/*! ClearVision v6.1.2 by the CV team */
...
.colorable-1bkp8v.white-3GPOIp:not(:hover) {
  background-color: var(--main-color) !important;
}
...
.standardSidebarView-3F1I7i .sidebar-CFHs9e .side-8zPYf6 [style*="color: hsl(359, calc(var(--saturation-factor, 1) * 82.6%), 59.4%)"].item-PXvHYJ:hover {
  color: var(--danger-color) !important;
}
